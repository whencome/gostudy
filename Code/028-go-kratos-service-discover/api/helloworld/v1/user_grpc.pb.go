...
func (c *userClient) QueryUser(ctx context.Context, in *QueryUserRequest, opts ...grpc.CallOption) (*QueryUserReply, error) {
	out := new(QueryUserReply)
	err := c.cc.Invoke(ctx, "/api.helloworld.v1.User/QueryUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServer) QueryUser(context.Context, *QueryUserRequest) (*QueryUserReply, error) {
...
func _User_QueryUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.helloworld.v1.User/QueryUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
